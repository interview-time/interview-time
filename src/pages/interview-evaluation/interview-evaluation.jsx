...
const InterviewEvaluation = ({ interviews, loadInterviews, updateInterview }) => {
    ...
    const CompetenceAreaCard = () => (
        <Card title="Competence Areas" bodyStyle={bodyStyleCard()} loading={initialLoading()}>
    ...
    const OverallPerformanceCard = () => (
        <Card title="Overall Performance" bodyStyle={bodyStyleCard()} loading={initialLoading()}>
    ...
    const DecisionCard = () => (
        <Card style={{ marginBottom: 12 }} loading={initialLoading()}>
            <Row>
...
const mapDispatch = { loadInterviews, updateInterview };
