        ...
        description: (
            <div>
                <ul className={styles.list}>
                    ...
                    <li>
                        🆕 Previously input interview positions are now populated in the autocomplete during the
    ...
    },
    {
        ...
        description: (
            <div>
                <ul className={styles.list}>
                    <li>
                        🔥 Interview 'Report' page now displays charts based on answered questions that helps to make
                        even better candidate assessment.
                    </li>
                    <li>🆕 Added 'What's new' page.</li>
                    <li>🐛 Fixed issue when 'Report' page wasn't displaying questions with notes.</li>
                    <li>
                        🐛 Fixed issue when 'Report' page was displaying interviewer name instead of candidate name.
                    </li>
                </ul>
            </div>
        ),
    ...
    return (
        ...
        >
            <List
                ...
                renderItem={item => (
                    <List.Item>
                        <List.Item.Meta title={`${getFormattedDateShort(item.date)}`} description={item.description} />
                    </List.Item>
                )}
            />
        </Modal>
