...
const RequestQuestionModal = ({ visible, onCancel }) => {
    ...
    return (
        <Modal destroyOnClose={true} title={"Question Request"}
            ...
            <Space direction="vertical" style={{ width: "100%" }}>
                <Text strong>Missing Question?</Text>
                <Text>Tell us about the question you need, and we will add it.</Text>
            </Space>
            <Space direction="vertical" style={{ width: "100%", marginTop: 24 }}>
                <Text>Question</Text>
                <Input placeholder='Type question you need...'
